...
from config_price import STEPS, LOG_DIR, input_width, input_height, checkpoint_dir, dataset_loader, BATCH
...
if checkpoint_dir is None:
    current_time = "price_"+datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
...
trainer = PriceTrainer(model=model, checkpoint_dir=checkpoint_dir, class_mapping={},
                       ...
                       loss=tf.keras.losses.Huber(), metrics_name="mae")
